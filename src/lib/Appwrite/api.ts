...
export async function getSavedPosts() {
  try {
    ...
    if (!savedPost) throw new Error("No saved posts found");
...
// export async function updateUser(user: IUpdateUser) {
//   try {
//     const hasFileToUpdate = user.file && user.file.length > 0; // Check if user.file is defined before accessing its length
...
//     // ... (existing code for handling successful update and error cases)
